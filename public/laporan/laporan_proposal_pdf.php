<?php
// public/laporan/laporan_proposal_pdf.php
...
<body>
    ...
    <table class="data">
        ...
        <tbody>
            ...
            ?>
                <tr>
                    <td colspan="6" style="text-align: center; padding: 20px;">Tidak ada data proposal pada periode ini.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
...
$filename = 'Laporan_Proposal_' . date('Ymd_His') . '.pdf';
