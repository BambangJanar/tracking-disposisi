    ...
    <div class="flex-1 lg:ml-64">
        <main class="p-4 sm:p-6 lg:p-8">
            ...
            <div class="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 class="text-xl sm:text-2xl font-bold text-gray-800 mb-2">Laporan Surat Masuk</h1>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
                <div class="bg-white rounded-lg shadow p-3 sm:p-4 border-l-4 border-gray-600">
                    <p class="text-xs sm:text-sm text-gray-600 mb-1">Total Surat Masuk</p>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <?php else: ?>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-700"><?= htmlspecialchars($surat['dari_instansi'] ?? '-') ?></td>
