...
// Load settings dinamis (fallback ke default jika error)
$appName = defined('APP_NAME') ? APP_NAME : 'Tracking Disposisi';
$appDescription = 'Sistem Disposisi Digital'; // Default description
// Coba load setting dari helper jika ada, jika tidak pakai default
...
<body class="bg-gradient-to-br from-blue-500 to-blue-700 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-lg shadow-2xl p-8">
            <h2 class="text-2xl font-bold text-gray-800 mb-2 text-center">Daftar Akun Baru</h2>
            <p class="text-gray-500 text-sm text-center mb-6">Isi data diri Anda untuk mendaftar ke sistem</p>
            ...
            <form id="registerForm">
                ...
                <div class="mt-6 text-center border-t pt-4">
                    ...
                    <a href="login.php" class="text-blue-600 hover:text-blue-800 font-semibold text-sm">
                        Login disini
                    </a>
                </div>
            </form>
