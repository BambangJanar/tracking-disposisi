                ...
                <form method="GET" class="space-y-3 sm:space-y-0 sm:flex sm:gap-2">
                    ...
                    <div class="flex gap-2">
                        ...
                        <?php if (!empty($filters['search']) || !empty($filters['status_disposisi'])): ?>
                            <a href="disposisi.php" class="flex-1 sm:flex-none bg-gray-400 hover:bg-gray-500 text-white px-4 py-2 rounded-lg text-sm font-medium text-center transition-colors">
