...
<script>
    ...
    // Auto-open modal jika ada parameter ?action=tambah (dari Dashboard)
    const urlParams = new URLSearchParams(window.location.search);
    if (urlParams.get('action') === 'tambah') {
        openAddModal();
        // Bersihkan parameter dari URL agar tidak membuka lagi saat refresh
