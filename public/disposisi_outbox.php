...
<div class="flex min-h-screen">
    ...
    <div class="flex-1 lg:ml-64">
        <main class="p-6 lg:p-8">
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-gray-800 mb-2">Disposisi Keluar</h1>
                <p class="text-gray-600">Daftar disposisi yang Anda kirimkan</p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-4 mb-6">
                <form method="GET" class="flex flex-col sm:flex-row gap-2">
                    ...
                    <a href="disposisi_outbox.php" class="bg-gray-400 hover:bg-gray-500 text-white px-4 py-2 rounded-lg text-sm">
