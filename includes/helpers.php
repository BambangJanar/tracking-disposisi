...
// Get badge class untuk tingkat/prioritas surat
function getTingkatSuratBadge($tingkat) {
    $badges = [
        'biasa'    => 'bg-gray-100 text-gray-700 border-gray-200',
    ...
    return $badges[$tingkat] ?? $badges['biasa'];
}

// Get icon untuk tingkat/prioritas surat
function getTingkatSuratIcon($tingkat) {
    $icons = [
        'biasa'    => 'fas fa-minus-circle text-gray-400',
        'sedang'   => 'fas fa-info-circle text-blue-500',
        'penting'  => 'fas fa-exclamation-circle text-orange-500',
        'mendesak' => 'fas fa-exclamation-triangle text-red-500',
    ];
    return $icons[$tingkat] ?? $icons['biasa'];
}

// Get label untuk tingkat/prioritas surat
function getTingkatSuratLabel($tingkat) {
    $labels = [
        'biasa'    => 'Biasa',
        'sedang'   => 'Sedang',
        'penting'  => 'Penting',
